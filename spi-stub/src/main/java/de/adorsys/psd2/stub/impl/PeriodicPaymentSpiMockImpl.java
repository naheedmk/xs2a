...
public class PeriodicPaymentSpiMockImpl implements PeriodicPaymentSpi {
    ...
    public @NotNull SpiResponse<SpiPaymentConfirmationCodeValidationResponse> checkConfirmationCode(@NotNull SpiContextData contextData, @NotNull SpiConfirmationCode spiConfirmationCode, @NotNull String authorisationId, @NotNull SpiAspspConsentDataProvider aspspConsentDataProvider) {
        log.info("PeriodicPaymentSpi#checkConfirmationCode: contextData {}, spiConfirmationCode{}, authorisationId {}, aspspConsentData {}", contextData, spiConfirmationCode.getConfirmationCode(), authorisationId, aspspConsentDataProvider.loadAspspConsentData());
