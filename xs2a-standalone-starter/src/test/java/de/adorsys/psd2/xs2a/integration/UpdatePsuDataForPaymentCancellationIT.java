...
public class UpdatePsuDataForPaymentCancellationIT {
    ...
    public void updatePsuData_success() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = put(UrlBuilder.buildUpdatePsuDataForPaymentCancellationUrl(PaymentType.SINGLE.getValue(), SEPA_PAYMENT_PRODUCT, ENCRYPT_PAYMENT_ID, AUTHORISATION_ID));
    ...
    public void updatePsuData_wrongAuthorisationId() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = put(UrlBuilder.buildUpdatePsuDataForPaymentCancellationUrl(PaymentType.SINGLE.getValue(), SEPA_PAYMENT_PRODUCT, ENCRYPT_PAYMENT_ID, WRONG_AUTHORISATION_ID));
        requestBuilder.content(jsonReader.getStringFromFile("json/auth/req/update_password.json"));
        requestBuilder.headers(httpHeaders);
