...
public class SpiToXs2aSinglePaymentMapperTest {
    ...
    private SpiSinglePayment buildSpiSinglePayment() {
        ...
        SpiAccountReference accountReference = jsonReader.getObjectFromFile("json/support/mapper/spi-account-reference.json", SpiAccountReference.class);
        ...
        payment.setCreditorAddress(jsonReader.getObjectFromFile("json/support/mapper/spi-address.json", SpiAddress.class));
