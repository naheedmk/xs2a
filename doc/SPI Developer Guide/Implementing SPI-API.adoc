...
* *spiContextData*;
* *spiAccountConsent* - provided data about the AIS consent from TPP;
* *spiAspspConsentDataProvider*.
...
The method *revokeAisConsent* provides a possibility to revoke the given AIS consent (change its status to `FINALISED`). Parameters of the method are:
