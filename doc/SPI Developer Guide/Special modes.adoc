...
* First of all Connector Developer should define custom local swagger api yaml file and set xs2a.swagger.psd2.api.location project property to point at this file.
* Next steps involve adding and changing necessary parameters.

The defoult version of psd2.yaml file can be found under:
```
