...
public class AisConsentUsageService {
    ...
    @Transactional
    public void incrementUsage(Consent aisConsent, AisConsentActionRequest request) {
    ...
    @Transactional
    public void resetUsage(Consent aisConsent) {
    ...
    @Transactional
    public Map<String, Integer> getUsageCounterMap(Consent aisConsent) {
    ...
    private AisConsentUsage getUsage(Consent aisConsent, String requestUri) {
