...
//        when(securityDataService.decryptId(ENCRYPTED_CONSENT_ID)).thenReturn(Optional.of(DECRYPTED_CONSENT_ID));
//        when(aisConsentService.getConsentById(DECRYPTED_CONSENT_ID))
//            .thenReturn(CmsResponse.<AisAccountConsent>builder()
//                            .payload(buildAisAccountConsent())
//                            .build());
//
//        // When
//        CmsResponse<AisAccountConsent> actual = aisConsentServiceInternalEncrypted.getConsentById(ENCRYPTED_CONSENT_ID);
//
//        // Then
//        assertTrue(actual.isSuccessful());
//
//        assertEquals(expected, actual.getPayload());
//        verify(aisConsentService, times(1)).getConsentById(DECRYPTED_CONSENT_ID);
//    }
//
//    @Test
//    void getAisAccountConsentById_internalServiceFailed() {
//        when(securityDataService.decryptId(ENCRYPTED_CONSENT_ID)).thenReturn(Optional.of(DECRYPTED_CONSENT_ID));
//        when(aisConsentService.getConsentById(any()))
//            .thenReturn(CmsResponse.<AisAccountConsent>builder()
//                            .error(CmsError.LOGICAL_ERROR)
//                            .build());
//
...
//        // When
//        CmsResponse<AisAccountConsent> actual = aisConsentServiceInternalEncrypted.getConsentById(UNDECRYPTABLE_CONSENT_ID);
//
//        // Then
//        assertTrue(actual.hasError());
//
//        assertEquals(CmsError.TECHNICAL_ERROR, actual.getError());
//        verify(aisConsentService, never()).getConsentById(any());
//    }
//
//    @Test
