...
class CmsPsuAisServiceInternalTest {
    ...
    void getPsuDataAuthorisations_Success() {
        ...
        when(authorisationRepository.findAllByParentExternalIdAndAuthorisationType(EXTERNAL_CONSENT_ID, AuthorisationType.CONSENT))
    ...
    private AuthorisationEntity buildAisConsentAuthorisation() {
        ...
        aisConsentAuthorization.setAuthorisationType(AuthorisationType.CONSENT);
