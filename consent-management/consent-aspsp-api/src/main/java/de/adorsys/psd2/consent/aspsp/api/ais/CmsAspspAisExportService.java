...
public interface CmsAspspAisExportService {
     ...
     */
    Collection<CmsPsuAspspAccountConsent> exportConsentsByTpp(String tppAuthorisationNumber,
     ...
     *                                 developer shall limit his/her request, making pagination by dates.
     */
    Collection<CmsPsuAspspAccountConsent> exportConsentsByPsu(PsuIdData psuIdData,
                                                              @Nullable LocalDate createDateFrom, @Nullable LocalDate createDateTo,
     ...
     *                                 developer shall limit his/her request, making pagination by dates.
     */
    Collection<CmsPsuAspspAccountConsent> exportConsentsByAccountId(@NotNull String aspspAccountId,
                                                                    @Nullable LocalDate createDateFrom, @Nullable LocalDate createDateTo,
                                                                    @NotNull String instanceId);
}
