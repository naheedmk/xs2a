...
interface ConsentServiceBase {
     ...
     */
    CmsResponse<CreateConsentResponse> createConsent(CreateConsentRequest request) throws WrongChecksumException;
     ...
     */
    CmsResponse<CmsAccountConsent> getAccountConsentById(String consentId);
     ...
     */
    CmsResponse<CmsAccountConsent> updateAspspAccountAccessWithResponse(String consentId, AisAccountAccessInfo request) throws WrongChecksumException;
