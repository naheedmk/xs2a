...
class AccountReferenceInConsentUpdaterTest {
    ...
    void updateAccountReferences_withGlobalConsent_shouldSetResourceId() {
        ...
        // When
        accountReferenceInConsentUpdater.updateAccountReferences(CONSENT_ID, accountAccess, Collections.singletonList(xs2aAccountDetails));
    ...
    void updateAccountReferences_withMultipleAccountReferences_shouldProperlyUpdateResourceId() {
        ...
        // When
        accountReferenceInConsentUpdater.updateAccountReferences(CONSENT_ID, accountAccess, Arrays.asList(xs2aAccountDetails, xs2aAccountDetails2));
    ...
    private AccountAccess buildXs2aAccountAccess(List<AccountReference> accounts,
        ...
        return new AccountAccess(accounts, balances, transactions, accessType, accessType, accessType, null);
    }
