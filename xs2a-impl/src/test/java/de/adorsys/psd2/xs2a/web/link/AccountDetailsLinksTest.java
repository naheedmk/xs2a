...
//    @Test
//    void create_success() {
//        AccountDetailsLinks links = new AccountDetailsLinks(HTTP_URL, ACCOUNT_ID, accountAccess);
//
...
//        AccountDetailsLinks links = new AccountDetailsLinks(HTTP_URL, ACCOUNT_ID, accountAccessGlobal);
//
//        expectedLinks.setBalances(new HrefType("http://url/v1/accounts/33333-999999999/balances"));
//        expectedLinks.setTransactions(new HrefType("http://url/v1/accounts/33333-999999999/transactions"));
//        assertEquals(expectedLinks, links);
