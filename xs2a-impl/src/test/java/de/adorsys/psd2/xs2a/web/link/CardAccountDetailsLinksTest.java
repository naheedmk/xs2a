...
class CardAccountDetailsLinksTest {
    ...
    private AccountAccess accountAccessGlobal;
    ...
    void setUp() {
        ...
        accountAccessGlobal = jsonReader.getObjectFromFile("json/link/account_access-global.json", AccountAccess.class);
        expectedLinks = new Links();
    }

    @Test
    void create_success() {
        CardAccountDetailsLinks links = new CardAccountDetailsLinks(HTTP_URL, ACCOUNT_ID, accountAccess);
    ...
    void create_globalConsent_success() {
        CardAccountDetailsLinks links = new CardAccountDetailsLinks(HTTP_URL, ACCOUNT_ID, accountAccessGlobal);
