...
//        when(accountReferenceUpdater.updateAccountReferences(CONSENT_ID, aisConsent.getAccess(), xs2aAccountDetailsList))
...
//
//        verify(accountReferenceUpdater).updateAccountReferences(CONSENT_ID, aisConsent.getAccess(), xs2aAccountDetailsList);
...
//
//        aisConsent.setConsentData(new AisConsentData(createAccountAccess(),
//                                                     createAccountAccess(),
//                                                     false));
//
