...
class GetTransactionsReportValidatorTest {
    ...
    void validate_withInvalidAccountReference_shouldReturnInvalid() {
        ...
        when(accountReferenceAccessValidator.validate(aisConsent.getAccess(), aisConsent.getAccess().getTransactions(), ACCOUNT_ID, AisConsentRequestType.DEDICATED_ACCOUNTS)).thenReturn(ValidationResult.valid());
