...
class PaymentAuthorisationServiceTest {
    ...
    void getPaymentInitiationAuthorisationScaStatus_success() {
        // Given
        PisCommonPaymentResponse commonPaymentResponse = buildPisCommonPaymentResponse();
        GetPaymentScaStatusRequest getPaymentScaStatusRequest = new GetPaymentScaStatusRequest(PSU_ID_DATA, commonPaymentResponse, ScaStatus.RECEIVED);
        ...
        // When
        ResponseObject<GetPaymentScaStatusRequest> actual = paymentAuthorisationService.getPaymentInitiationAuthorisationScaStatus(PAYMENT_ID,
    ...
    void getPaymentInitiationAuthorisationScaStatus_shouldStoreStatusesInLoggingContext() {
        ...
        // When
        ResponseObject<GetPaymentScaStatusRequest> response = paymentAuthorisationService.getPaymentInitiationAuthorisationScaStatus(PAYMENT_ID, AUTHORISATION_ID, SINGLE, PAYMENT_PRODUCT);

        // Then
        assertFalse(response.hasError());
        assertEquals(getPaymentScaStatusRequest, response.getBody());
    ...
    void getPaymentInitiationAuthorisationScaStatus_failure_wrongIds() {
        ...
        // When
        ResponseObject<GetPaymentScaStatusRequest> actual = paymentAuthorisationService.getPaymentInitiationAuthorisationScaStatus(WRONG_PAYMENT_ID,
    ...
    void getPaymentInitiationAuthorisationScaStatus_withInvalidPayment_shouldReturnValidationError() {
        ...
        // When
        ResponseObject<GetPaymentScaStatusRequest> actualResponse = paymentAuthorisationService.getPaymentInitiationAuthorisationScaStatus(PAYMENT_ID,
                                                                                                                          AUTHORISATION_ID, SINGLE, PAYMENT_PRODUCT);
