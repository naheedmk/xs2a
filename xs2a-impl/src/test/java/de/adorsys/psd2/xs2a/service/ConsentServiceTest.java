...
//        // Given
//        AccountAccess access = getAccess(Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), true, false);
...
//        return new AccountAccess(accounts, null, null, null, null, null, null);
//    }
//
...
//
//        aisConsent.setConsentData(new AisConsentData(getXs2aAccountAccess(Collections.singletonList(getXs2aReference())),
//                                                     getXs2aAccountAccess(Collections.singletonList(getXs2aReference())),
//                                                     false));
//        return aisConsent;
//    }
//
...
//        return new AccountAccess(accounts, balances, transactions, allAccounts ? AccountAccessType.ALL_ACCOUNTS : null, allPsd2 ? AccountAccessType.ALL_ACCOUNTS : null, null, null);
//    }
//
